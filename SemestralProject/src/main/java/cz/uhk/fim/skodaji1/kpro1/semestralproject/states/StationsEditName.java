...
public class StationsEditName extends State
{
    ...
    public void HandleInput(String input)
    {
        ...
        {
            if (cz.uhk.fim.skodaji1.kpro1.semestralproject.data.Stations.GetInstance().CheckFreeName(input) == false && !input.toLowerCase().equals(this.stationName.toLowerCase()))
            {
