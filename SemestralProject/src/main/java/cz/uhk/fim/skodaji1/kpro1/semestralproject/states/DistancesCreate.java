...
public class DistancesCreate extends State
{
    ...
    public void Load()
    {
        this.stations = cz.uhk.fim.skodaji1.kpro1.semestralproject.data.Stations.GetInstance().GetAllStations();
        if (this.stations.length > 1)
        {
            cz.uhk.fim.skodaji1.kpro1.semestralproject.data.Distances.GetInstance().SetAllZeroes();
            this.origin = 0;
            this.destination = 1;
        }
    }
    ...
    public Screen GetScreen()
    {
        if (this.stations.length > 1)
        {
            ...
            data.put("stations_distances_tr", cz.uhk.fim.skodaji1.kpro1.semestralproject.data.Distances.GetInstance().GenerateDistancesRows(this.stations[this.origin]));
    ...
    public void HandleInput(String input)
    {
        ...
        else if (this.CheckInt(input) == true)
        {
            ...
            {
                cz.uhk.fim.skodaji1.kpro1.semestralproject.data.Distances.GetInstance().SetDistance(
    ...
    private boolean NextStationsDistance()
    {
        ...
        else if (cz.uhk.fim.skodaji1.kpro1.semestralproject.data.Distances.GetInstance().GetDistance(this.stations[this.origin], this.stations[this.destination]) != 0)
        {
            reti = this.NextStationsDistance();
        }
        else
