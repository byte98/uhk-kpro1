            ...
            else
            {
                switch (this.progress)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        Station to = cz.uhk.fim.skodaji1.kpro1.semestralproject.data.Stations.GetInstance().GetStation(input);
                        if (to == null)
                        {
                            this.controller.ShowError("Neznama stanice '" + input + "'!");
                        }
                        ...
                        {
                            this.destination = to;
                            String distance = cz.uhk.fim.skodaji1.kpro1.semestralproject.data.Distances.GetInstance().GetDistance(this.origin, this.destination) + " km";
                            if (this.tariff.GetType() == TariffType.ZONE)
                            {
                                ZoneTariff zt = (ZoneTariff) this.tariff;
