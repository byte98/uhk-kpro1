    ...
    public void HandleInput(String input)
    {
        switch (input.toLowerCase())
        {
            case "no":
                ...
                break;
            case "yes":
                cz.uhk.fim.skodaji1.kpro1.semestralproject.data.Stations.GetInstance().EditStation(cz.uhk.fim.skodaji1.kpro1.semestralproject.data.Stations.GetInstance().GetStation(this.stationAbbr), this.newStationName, this.newStationAbbr);
